// В изначальных вариант внесены следующие изменения:
// Для ввода значений минут и секунд таймера используются input - элементы с валидизацией полученных от пользователя данных;
// Добавлена возможность ставить таймер на паузу;
// Добавлены кнопки увеличения/уменьшения  на единицу значений минут и секунд ;
// По окончании работы таймера выводится соответствующий текст и кнопка для перезапуска таймера;
// В коде используются объекты и функция-конструктор;
// В коде используется доработанный helper из прошлых уроков (добавлен метод change(), работающий аналогично соответствующему методу jQuery)
// Надеюсь, код приятно читать )
